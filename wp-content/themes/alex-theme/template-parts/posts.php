<div class="container--sub container__wrap container__spaced container--sub__padded-large container--sub__stretched container__black">
  ...
  <?php while ( have_posts() ):
    ...
    <a href="<?php the_permalink() ?>" class="container container__column container__left container__column--start">
      ...
      <div class="listing-container">
        ...
        <h4 class="h5 h__left h h__shift-up white"><?= get_the_date() ?></h4>
